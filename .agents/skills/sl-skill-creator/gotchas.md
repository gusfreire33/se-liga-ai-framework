...
- No numeric word or character cap applies — density (every sentence is a fact, decision, constraint, link, or signal) is the rule. See `.claude/skills/sl-doc-schemas/SKILL.md` for the output-length doctrine.
