...
| File | Purpose |
|------|---------|
| `.codex/skills/sl-ux-design/design-direction.md` | Design Thinking, Quality Score, Output Structure |
| `.codex/skills/sl-ux-design/ux-laws-principles.md` | UX Laws, Cognitive Load, Mental Models |
| `.codex/skills/sl-ux-design/modern-patterns.md` | Interaction patterns, visual trends, performance UX |
| `.codex/skills/sl-ux-design/saas-patterns.md` | SaaS surface patterns (Dashboard, Settings, Billing, etc.) |
| `.codex/skills/sl-ux-design/ux-writing.md` | Microcopy, error messages, empty states |
| `.codex/skills/sl-ux-design/design-md/index.md` | **DESIGN.md token specs** (cores/tipo concretos por marca) + template + catálogo |

### Docs Lookup

| Library | Doc file |
|---------|----------|
| shadcn | `.codex/skills/sl-ux-design/shadcn-docs.md` |
| tailwind | `.codex/skills/sl-ux-design/tailwind-v3-docs.md` |
| motion | `.codex/skills/sl-ux-design/motion-dev-docs.md` |
| recharts | `.codex/skills/sl-ux-design/recharts-docs.md` |
| @tanstack/react-table | `.codex/skills/sl-ux-design/tanstack-table-docs.md` |
| @tanstack/react-query | `.codex/skills/sl-ux-design/tanstack-query-docs.md` |
| @tanstack/react-router | `.codex/skills/sl-ux-design/tanstack-router-docs.md` |
