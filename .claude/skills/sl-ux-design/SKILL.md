...
| File | Purpose |
|------|---------|
| `.claude/skills/sl-ux-design/design-direction.md` | Design Thinking, Quality Score, Output Structure |
| `.claude/skills/sl-ux-design/ux-laws-principles.md` | UX Laws, Cognitive Load, Mental Models |
| `.claude/skills/sl-ux-design/modern-patterns.md` | Interaction patterns, visual trends, performance UX |
| `.claude/skills/sl-ux-design/saas-patterns.md` | SaaS surface patterns (Dashboard, Settings, Billing, etc.) |
| `.claude/skills/sl-ux-design/ux-writing.md` | Microcopy, error messages, empty states |
| `.claude/skills/sl-ux-design/design-md/index.md` | **DESIGN.md token specs** (cores/tipo concretos por marca) + template + catálogo |

### Docs Lookup

| Library | Doc file |
|---------|----------|
| shadcn | `.claude/skills/sl-ux-design/shadcn-docs.md` |
| tailwind | `.claude/skills/sl-ux-design/tailwind-v3-docs.md` |
| motion | `.claude/skills/sl-ux-design/motion-dev-docs.md` |
| recharts | `.claude/skills/sl-ux-design/recharts-docs.md` |
| @tanstack/react-table | `.claude/skills/sl-ux-design/tanstack-table-docs.md` |
| @tanstack/react-query | `.claude/skills/sl-ux-design/tanstack-query-docs.md` |
| @tanstack/react-router | `.claude/skills/sl-ux-design/tanstack-router-docs.md` |
