...
- No numeric word or character cap applies. Output length is governed by depth floors per `.claude/skills/sl-doc-schemas/SKILL.md`.
...
- [ ] Every section meets its content requirement and stops there — no filler, no padding (no numeric word/char cap; see `.claude/skills/sl-doc-schemas/SKILL.md`)?
